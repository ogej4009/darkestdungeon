...
#include "GameMacro.h"
#include "string"
//선생님 스타일 -> 다 랩핑시키고 사용 인터페이스만 호출하게 해줌
...
private:
	...
	static GameInputStatic m_Inst; //static 로딩 기법,싱글톤 대용으로 쓰는듯

    // 포인터형 싱글톤
	//static HGAMEINPUT* m_pInst;
	//static HGAMEINPUT* Inst()
	//{
	//	if (nullptr == m_pInst)
	//	{
	//		m_pInst = new HGAMEINPUT();
	//	}
	//	return m_pInst;
	//}

// 이녀석은 내가 원할때 부술수 있습니까??
/*
	static HGAMEINPUT& Inst()
	{
		static HGAMEINPUT Inst;
